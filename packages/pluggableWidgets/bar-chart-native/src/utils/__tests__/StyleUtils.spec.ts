...
describe("StyleMappers", () => {
    describe("mapToGridStyle", () => {
        it("maps the relevant styles", () => {
            const gridStyle: BarChartGridStyle = {
    ...
    describe("mapToAxisStyle", () => {
        it("maps the relevant styles", () => {
            ...
            const axisStyle: BarChartAxisStyle<"Y"> = {
                color: "green",
                dashArray: "10,10",
    ...
    describe("mapToBarStyles", () => {
        it("maps the relevant styles", () => {
            ...
            const expectedResult = {
                ...
                cornerRadius: styles.bar?.ending
            };

            expect(mapToBarStyles("red", styles)).toStrictEqual(expectedResult);
        });
...
describe("aggregateGridPadding", () => {
    let gridStyle: BarChartGridStyle;
